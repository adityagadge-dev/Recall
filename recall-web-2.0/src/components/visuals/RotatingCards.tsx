              ...
              >
                ...
                <div className="relative z-20 h-full p-6 sm:p-10 flex flex-col justify-end">
                  ...
                  <div className="mb-4 transform translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500 ease-out">
                    <span 
                      className="text-[10px] sm:text-xs font-bold uppercase tracking-[0.2em] px-3 py-1 rounded-full border border-white/10 bg-[#11151F]/5 backdrop-blur-md"
                  ...
                  <div className="flex flex-wrap gap-2 mb-8">
                    {card.skills.map(skill => (
                      <span key={skill} className="text-xs font-bold text-white/70 bg-[#11151F]/5 border border-white/10 rounded-md px-2.5 py-1 backdrop-blur-sm">
                        {skill}
                      </span>
                    ))}
                  </div>
