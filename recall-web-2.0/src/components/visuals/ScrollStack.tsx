...
export const ScrollStackItem = ({ children, itemClassName = '' }: any) => (
  <div
    className={`scroll-stack-card relative w-full h-[60vh] min-h-[400px] my-8 p-10 md:p-16 rounded-[40px] shadow-[0_20px_50px_rgba(0,0,0,0.1)] box-border origin-top will-change-transform bg-[#11151F] border border-[#1A2030] ${itemClassName}`.trim()}
