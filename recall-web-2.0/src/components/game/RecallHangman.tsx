            ...
            {!gameOver ? (
              ...
              >
                ...
                <button
                  onClick={resetGame}
                  data-no-global-sound="true"
                  className="flex items-center gap-2 bg-[#F7F8FC] text-[#07080C] px-8 py-3 rounded-xl font-bold text-sm shadow-md hover:bg-[#11151F] hover:-translate-y-1 active:scale-95 transition-all w-full justify-center"
                >
