...
export const ParaWiseQuestionView: React.FC<{
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 max-w-5xl mx-auto">
      ...
      <div className="lg:col-span-5 rounded-3xl border border-[#323B4E] bg-[#11151F] p-6 space-y-3 h-fit">
        ...
        <h4 className="text-base font-bold text-[#F7F8FC]">{passageTitle}</h4>
        <div className="prose prose-invert text-xs text-[#9AA4B8] leading-relaxed max-h-[420px] overflow-y-auto pr-2 space-y-3">
          <p>{passage}</p>
        </div>
      </div>
      ...
      <div className="lg:col-span-7">
        {currentQ && (
          <div className="rounded-3xl border border-[#323B4E] bg-[#0D1017] p-6 space-y-4">
            <div className="flex items-center justify-between text-xs text-[#9AA4B8] border-b border-[#323B4E] pb-3">
            ...
            <h3 className="text-base font-bold text-[#F7F8FC] leading-snug">{currentQ.prompt}</h3>
            ...
            <div className="space-y-2.5 pt-2">
              {currentQ.options?.map((opt) => (
                <button
                  ...
                  className="w-full text-left rounded-xl border border-[#323B4E] bg-[#0D1017] p-3.5 text-xs text-[#F7F8FC] hover:border-[#0F766E] hover:bg-[#0D1017] transition"
                >
                  {opt.text}
                </button>
              ))}
...
export const AssessmentResultSummary: React.FC<{
  ...
  return (
    <motion.div
      ...
      className="max-w-2xl mx-auto rounded-3xl border border-[#323B4E] bg-[#11151F] p-6 sm:p-8 text-center shadow-2xl space-y-6"
    >
      ...
      <div>
        ...
        <h2 className="text-2xl font-extrabold text-[#F7F8FC]">{title}</h2>
      ...
      <div className="grid grid-cols-3 gap-3 rounded-2xl border border-[#323B4E] bg-[#0D1017] p-4 text-center">
        <div>
          <span className="text-[10px] font-bold text-[#9AA4B8] uppercase">Accuracy</span>
          <div className="text-lg font-bold text-[#F7F8FC] font-mono">{percentage}%</div>
          <span className="text-[10px] text-[#9AA4B8]">{correctCount}/{totalQuestions} correct</span>
        </div>
        <div className="border-x border-[#323B4E]">
          <span className="text-[10px] font-bold text-[#9AA4B8] uppercase">XP Awarded</span>
          ...
          <span className="text-[10px] text-[#9AA4B8]">Total Reward</span>
        </div>
        <div>
          <span className="text-[10px] font-bold text-[#9AA4B8] uppercase">Mastery Boost</span>
          <div className="text-lg font-bold text-[#0F766E] font-mono">+12%</div>
          <span className="text-[10px] text-[#9AA4B8]">Node progress</span>
        </div>
      </div>
      ...
      <div className="flex flex-wrap items-center justify-center gap-3 pt-2">
        {onRetry && (
          <button
            onClick={onRetry}
            className="flex items-center gap-2 rounded-xl border border-[#323B4E] bg-[#0D1017] px-5 py-2.5 text-xs font-semibold text-[#F7F8FC] hover:text-[#F7F8FC] transition"
          >
