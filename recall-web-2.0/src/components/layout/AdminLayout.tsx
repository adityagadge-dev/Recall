...
export const AdminLayout: React.FC = () => {
  ...
  return (
    <div id="admin-portal-root" className="min-h-screen bg-[#07080C] text-[#F7F8FC] flex flex-col md:flex-row font-sans selection:bg-[#475569] selection:text-white">
      {/* Sidebar */}
      <aside className="hidden md:flex flex-col w-64 shrink-0 bg-[#0D1017] border-r border-[#1A2030] p-4 justify-between h-screen sticky top-0 overflow-hidden shadow-sm z-40">
        <div>
          <Link to="/" className="flex items-center gap-2.5 px-2 py-3 mb-6">
            <RecallLogo color="#475569" />
          </Link>
          
          <div className="mb-6 rounded-2xl border border-[#1A2030] bg-[#0D1017] p-3 flex items-center justify-between text-xs text-[#F7F8FC] font-bold shadow-sm">
            <div className="flex items-center gap-2">
              <ShieldAlert className="h-4 w-4 text-[#9AA4B8]" />
        ...
        <div className="pt-4 border-t border-[#1A2030] space-y-2">
          <Link
            to="/admin/settings"
            className="flex items-center gap-3 rounded-xl p-2 transition hover:bg-[#0D1017] border border-transparent hover:border-[#1A2030]"
          >
            <img
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="text-xs text-[#9AA4B8] truncate">Platform Administrator</p>
            </div>
          </Link>
          <button
            onClick={signOut}
            className="flex w-full items-center gap-2 rounded-xl px-3 py-2 text-xs font-bold text-[#9AA4B8] hover:bg-[#1A2030] hover:text-slate-800 transition"
          >
      ...
      <div className="flex-1 flex flex-col min-w-0 h-screen overflow-y-auto">
        <header className="sticky top-0 z-30 flex h-16 items-center justify-between border-b border-[#1A2030] bg-[#0D1017]/90 px-4 sm:px-6 lg:px-8 backdrop-blur-md">
          <div className="flex items-center gap-3">
            ...
            <span className="rounded-md bg-[#1A2030] px-2 py-0.5 text-[10px] font-bold text-[#9AA4B8] border border-[#1A2030]">
              Super-Admin Tier
            </span>
          </div>
          <div className="flex items-center gap-3">
            <Link
              to="/admin/system"
              className="flex items-center gap-1.5 rounded-full border border-[#1A2030] bg-[#0D1017] px-4 py-2 text-xs font-bold text-[#9AA4B8] hover:bg-[#1A2030] transition shadow-sm"
            >
              <Server className="h-4 w-4 text-[#9AA4B8]" />
