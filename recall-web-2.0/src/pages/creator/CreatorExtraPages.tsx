  ...
  return (
    <div id="topic-management-page" className="space-y-8 pb-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {topics.map((t) => (
          <div key={t.id} className="rounded-3xl border border-[#323B4E] bg-[#11151F] p-6 space-y-3">
            <div className="flex items-center justify-between">
              <span className="rounded bg-orange-500/10 px-2 py-0.5 text-[10px] font-mono text-rose-500 font-bold uppercase">
                {t.subjectCategory}
              </span>
              <span className="text-xs text-[#9AA4B8] font-mono">{t.difficultyTier} Tier</span>
            </div>
            <h3 className="text-base font-bold text-[#4C0519]">{t.title}</h3>
            <p className="text-xs text-[#9AA4B8] leading-relaxed">{t.description}</p>
            <div className="border-t border-[#323B4E] pt-3 flex items-center justify-between text-xs text-[#9AA4B8] font-mono">
  ...
  return (
    <div id="assessment-config-page" className="space-y-8 pb-12">
      ...
      <div className="rounded-3xl border border-[#323B4E] bg-[#11151F] p-6 space-y-4">
        ...
        <div className="space-y-3 text-xs text-[#9AA4B8]">
          <div className="flex items-center justify-between p-3 rounded-xl bg-[#0D1017] border border-[#323B4E]">
      ...
      <div className="rounded-3xl border border-[#323B4E] bg-[#11151F] p-6 sm:p-8">
        <div className="flex items-center gap-6">
          ...
          <div>
            ...
            <p className="text-xs text-[#9AA4B8] mt-1">marcus@recall.institute • Joined February 2026</p>
            <p className="text-xs text-[#9AA4B8] mt-2">
