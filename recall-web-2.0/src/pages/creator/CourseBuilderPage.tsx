...
export const CourseBuilderPage: React.FC = () => {
  ...
  return (
    <div id="course-builder-page" className="max-w-4xl mx-auto space-y-8 pb-12">
      <div className="flex items-center justify-between border-b border-[#323B4E] pb-6">
        <div>
      ...
      <form onSubmit={handleSave} className="space-y-6">
        {/* Core Metadata */}
        <div className="rounded-3xl border border-[#323B4E] bg-[#11151F] p-6 sm:p-8 space-y-4">
          <h3 className="text-base font-bold text-[#4C0519]">Course Overview</h3>

          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="sm:col-span-2">
              <label className="text-xs font-bold uppercase tracking-wider text-[#9AA4B8] block mb-1">Course Title</label>
              <input
                type="text"
                value={title}
                onChange={(e) => setTitle(e.target.value)}
                required
                className="w-full rounded-xl border border-[#323B4E] bg-[#0D1017] p-2.5 text-xs text-[#4C0519] placeholder-slate-500 focus:border-[#BE123C] focus:outline-none"
              />
            </div>

            <div>
              <label className="text-xs font-bold uppercase tracking-wider text-[#9AA4B8] block mb-1">Subject Pillar</label>
              <select
                value={subject}
                onChange={(e) => setSubject(e.target.value)}
                className="w-full rounded-xl border border-[#323B4E] bg-[#0D1017] p-2.5 text-xs text-[#4C0519] focus:border-[#BE123C] focus:outline-none"
              >
            ...
            <div>
              <label className="text-xs font-bold uppercase tracking-wider text-[#9AA4B8] block mb-1">Difficulty</label>
              <select
                value={difficulty}
            ...
            <div className="sm:col-span-2">
              <label className="text-xs font-bold uppercase tracking-wider text-[#9AA4B8] block mb-1">Description</label>
              <textarea
                rows={3}
                value={description}
                onChange={(e) => setDescription(e.target.value)}
                className="w-full rounded-xl border border-[#323B4E] bg-[#0D1017] p-2.5 text-xs text-[#F7F8FC] focus:border-[#BE123C] focus:outline-none resize-none"
              />
            </div>
          </div>
        </div>
        ...
        {/* Modules Builder */}
        <div className="rounded-3xl border border-[#323B4E] bg-[#11151F] p-6 sm:p-8 space-y-6">
          ...
          <div className="space-y-4">
            {modules.map((mod, i) => (
              <div key={mod.id} className="rounded-2xl border border-[#323B4E] bg-[#0D1017] p-5 space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="text-[#9AA4B8] hover:text-red-400 transition"
                  >
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-[#323B4E] bg-[#0D1017] p-2.5 text-xs font-bold text-[#4C0519] focus:border-[#BE123C] focus:outline-none"
                />

                <div className="space-y-2 pl-4 border-l-2 border-[#323B4E]">
                  <span className="text-[10px] font-bold uppercase tracking-wider text-[#9AA4B8]">Lessons in this module:</span>
                  {mod.lessons.map((les, j) => (
                    <div key={j} className="flex items-center gap-2">
                      <FileText className="h-3.5 w-3.5 text-[#9AA4B8]" />
                      <input
                        type="text"
                        value={les}
                        onChange={(e) => {
                        ...
                        className="flex-1 rounded-lg border border-[#323B4E] bg-[#0D1017] p-2 text-xs text-[#9AA4B8] focus:border-[#BE123C] focus:outline-none"
                      />
                    </div>
                  ))}
                </div>
  ...
  return (
    <div id="lesson-editor-page" className="max-w-4xl mx-auto space-y-8 pb-12">
      ...
      <div className="space-y-6">
        <div className="rounded-3xl border border-[#323B4E] bg-[#11151F] p-6 sm:p-8 space-y-4">
          <label className="text-xs font-bold uppercase tracking-wider text-[#9AA4B8] block">Lesson Title</label>
          <input
            type="text"
            value={lessonTitle}
            onChange={(e) => setLessonTitle(e.target.value)}
            className="w-full rounded-xl border border-[#323B4E] bg-[#0D1017] p-3 text-sm font-bold text-[#4C0519] focus:border-[#BE123C] focus:outline-none"
          />
        </div>

        <div className="rounded-3xl border border-[#323B4E] bg-[#11151F] p-6 sm:p-8 space-y-4">
          <label className="text-xs font-bold uppercase tracking-wider text-[#9AA4B8] block">1. Conceptual Primer (Introduction)</label>
          <textarea
            rows={3}
            value={intro}
            onChange={(e) => setIntro(e.target.value)}
            className="w-full rounded-xl border border-[#323B4E] bg-[#0D1017] p-3 text-xs text-[#F7F8FC] focus:border-[#BE123C] focus:outline-none resize-none leading-relaxed"
          />
        </div>
        ...
        <div className="rounded-3xl border border-[#323B4E] bg-[#11151F] p-6 sm:p-8 space-y-4">
          ...
          <textarea
            ...
            className="w-full rounded-xl border border-[#323B4E] bg-[#0D1017] p-3 text-xs font-mono text-rose-500 focus:border-[#BE123C] focus:outline-none resize-none leading-relaxed"
          />
        </div>
    ...
    <div id="diagnostic-builder-page" className="space-y-8 pb-12">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
        <div className="rounded-3xl border border-[#323B4E] bg-[#11151F] p-6 space-y-3">
          ...
          <p className="text-xs text-[#9AA4B8]">Define expected mental models, causality checks, and misconception flags for AI grading.</p>
        </div>
        ...
        <div className="rounded-3xl border border-[#323B4E] bg-[#11151F] p-6 space-y-3">
          ...
          <p className="text-xs text-[#9AA4B8]">Calibrate item response theory (IRT) weights for diagnostic baselines.</p>
        </div>
      </div>
    </div>
  );
