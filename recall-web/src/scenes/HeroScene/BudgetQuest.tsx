    ...
    <div className="bq">
      ...
      <div className="bq__frame">
        ...
        <div className="bq__actions">
          {!gameOver ? (
            <>
              <button className="btn-game bq__btn-skip" onClick={handleSkip} id="bq-skip">
                ← SKIP
              </button>
              <button className="btn-game bq__btn-buy" onClick={handleBuy} id="bq-buy">
                BUY →
              </button>
            </>
          ) : (
