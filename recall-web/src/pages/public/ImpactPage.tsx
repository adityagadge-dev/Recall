  ...
  return (
    <div className="bg-[#FFFBF0]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-32 space-y-24">
          ...
          {impacts.map((impact, idx) => {
            ...
            return (
              ...
              >
                ...
                <h4 className="text-lg font-bold text-[#25364A] mb-3">{impact.title}</h4>
                <p className="text-sm text-slate-600 leading-relaxed flex-1">{impact.desc}</p>
        ...
        <div className="pt-16 pb-8 border-t border-slate-200/60 max-w-4xl mx-auto">
           <div className="text-center mb-12 animate-in fade-in duration-700">
             <h3 className="text-xl font-bold text-[#25364A]">The Path to Real-World Mastery</h3>
           </div>
           ...
           <div className="relative flex flex-col md:flex-row justify-between items-center gap-4">
              ...
              {journeySteps.map((step, idx) => (
                ...
                >
                  <div className="flex h-10 w-10 items-center justify-center rounded-full bg-white border-2 border-[#F7C928] text-[#25364A] shadow-sm font-bold text-sm">
                    {idx + 1}
                  </div>
