  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-32 space-y-24">
      ...
      <div className="max-w-3xl space-y-6 text-center mx-auto animate-in fade-in slide-in-from-bottom-8 duration-700">
        <h1 className="text-4xl sm:text-5xl font-bold text-[#25364A] tracking-tight">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12 relative">
        ...
        <Link to="/app/subjects/financial-literacy" className="group relative flex flex-col bg-white p-8 sm:p-10 rounded-3xl border border-slate-200 hover:border-[#F7C928]/50 shadow-sm hover:shadow-xl transition-all duration-500 hover:-translate-y-2 overflow-hidden animate-in fade-in slide-in-from-bottom-8 delay-100 fill-mode-both">
          ...
          <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-amber-100 text-amber-600 mb-8 transition-transform duration-500 group-hover:scale-110 group-hover:-rotate-3">
            <Coins className="h-7 w-7" />
          </div>
          
          <h2 className="text-2xl font-bold text-[#25364A] mb-4">Financial Literacy</h2>
          ...
          <div className="flex items-center text-sm font-bold text-[#25364A] gap-2 pt-4 border-t border-slate-100 group-hover:text-amber-600 transition-colors">
            Explore Track <ArrowRight className="h-4 w-4 transition-transform duration-300 group-hover:translate-x-1" />
          </div>
        </Link>

        {/* Digital Safety */}
        <Link to="/app/subjects/digital-safety" className="group relative flex flex-col bg-white p-8 sm:p-10 rounded-3xl border border-slate-200 hover:border-blue-400/50 shadow-sm hover:shadow-xl transition-all duration-500 hover:-translate-y-2 overflow-hidden animate-in fade-in slide-in-from-bottom-8 delay-200 fill-mode-both">
          ...
          <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-blue-100 text-blue-600 mb-8 transition-transform duration-500 group-hover:scale-110 group-hover:-rotate-3">
            <ShieldCheck className="h-7 w-7" />
          </div>
          
          <h2 className="text-2xl font-bold text-[#25364A] mb-4">Digital Safety</h2>
          <p className="text-slate-600 mb-8 flex-1 leading-relaxed">
          ...
          <div className="flex items-center text-sm font-bold text-[#25364A] gap-2 pt-4 border-t border-slate-100 group-hover:text-blue-600 transition-colors">
            Explore Track <ArrowRight className="h-4 w-4 transition-transform duration-300 group-hover:translate-x-1" />
          </div>
        </Link>

        {/* First Aid */}
        <Link to="/app/subjects/first-aid" className="group relative flex flex-col bg-white p-8 sm:p-10 rounded-3xl border border-slate-200 hover:border-rose-300/50 shadow-sm hover:shadow-xl transition-all duration-500 hover:-translate-y-2 overflow-hidden animate-in fade-in slide-in-from-bottom-8 delay-300 fill-mode-both">
          ...
          <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-rose-100 text-rose-600 mb-8 transition-transform duration-500 group-hover:scale-110 group-hover:-rotate-3">
            <HeartPulse className="h-7 w-7" />
          </div>
          
          <h2 className="text-2xl font-bold text-[#25364A] mb-4">First Aid</h2>
          <p className="text-slate-600 mb-8 flex-1 leading-relaxed">
          ...
          <div className="flex items-center text-sm font-bold text-[#25364A] gap-2 pt-4 border-t border-slate-100 group-hover:text-rose-500 transition-colors">
            Explore Track <ArrowRight className="h-4 w-4 transition-transform duration-300 group-hover:translate-x-1" />
          </div>
        </Link>

        {/* Communication Skills */}
        <Link to="/app/subjects/communication" className="group relative flex flex-col bg-white p-8 sm:p-10 rounded-3xl border border-slate-200 hover:border-emerald-400/50 shadow-sm hover:shadow-xl transition-all duration-500 hover:-translate-y-2 overflow-hidden animate-in fade-in slide-in-from-bottom-8 delay-400 fill-mode-both">
          ...
          <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-emerald-100 text-emerald-600 mb-8 transition-transform duration-500 group-hover:scale-110 group-hover:-rotate-3">
            <MessageSquareShare className="h-7 w-7" />
          </div>
          
          <h2 className="text-2xl font-bold text-[#25364A] mb-4">Communication Skills</h2>
          <p className="text-slate-600 mb-8 flex-1 leading-relaxed">
          ...
          <div className="flex items-center text-sm font-bold text-[#25364A] gap-2 pt-4 border-t border-slate-100 group-hover:text-emerald-600 transition-colors">
            Explore Track <ArrowRight className="h-4 w-4 transition-transform duration-300 group-hover:translate-x-1" />
          </div>
        </Link>
      </div>
    ...
    <div className="bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-32 space-y-24">
        ...
        <div className="relative py-12">
          ...
          <div className="hidden lg:block absolute top-[4.5rem] left-8 right-8 h-1 bg-slate-100 rounded-full z-0 overflow-hidden">
            <div className="h-full bg-[#F7C928] w-full origin-left animate-in fade-in zoom-in-x-0 duration-1000 delay-300"></div>
          </div>
          
          {/* Vertical Line (Mobile) */}
          <div className="lg:hidden absolute top-8 bottom-8 left-[3.25rem] w-1 bg-slate-100 rounded-full z-0 overflow-hidden">
          ...
          <div className="flex flex-col lg:flex-row justify-between gap-12 lg:gap-4 relative z-10">
            {steps.map((step, idx) => {
              ...
              return (
                ...
                >
                  <div className={`flex h-16 w-16 shrink-0 items-center justify-center rounded-2xl border-2 transition-all duration-300 bg-white shadow-sm group-hover:-translate-y-2 group-hover:shadow-md ${isHovered ? 'border-[#F7C928] text-[#F7C928]' : 'border-slate-200 text-slate-400'}`}>
                    <Icon className="h-7 w-7" />
                  </div>
                  <div className="lg:text-center flex-1">
                    <span className="text-xs font-bold text-slate-400 mb-1 block">STEP {step.num}</span>
                    <h3 className="text-xl font-bold text-[#25364A] mb-2">{step.title}</h3>
        ...
        {/* Highlights Section */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch pt-12 border-t border-slate-100">
          
          {/* Teach-Back Highlight */}
          <div className="rounded-3xl bg-[#F2FAF6] border border-emerald-100 p-10 flex flex-col justify-center items-start group hover:-translate-y-1 transition-transform duration-300">
            <div className="h-12 w-12 rounded-full bg-emerald-100 text-emerald-600 flex items-center justify-center mb-6">
              <Sparkles className="h-6 w-6" />
            </div>
            <h3 className="text-2xl font-bold text-[#25364A] mb-4">Don't just answer it.<br/>Explain it.</h3>
            ...
            <div className="mt-auto bg-white/60 p-4 rounded-xl border border-emerald-200/50 w-full text-sm font-medium text-emerald-800">
              "So phishing is when someone pretends to be a trusted source to steal your data..."
            </div>
          </div>

          {/* Spin & Teach Preview */}
          <div className="rounded-3xl bg-[#FFFBF0] border border-[#F7C928]/30 p-10 flex flex-col justify-center items-center text-center group hover:-translate-y-1 transition-transform duration-300 overflow-hidden relative">
            ...
            <div className="relative z-10 flex flex-col items-center">
              <div className="h-12 w-12 rounded-full bg-amber-100 text-amber-600 flex items-center justify-center mb-6 group-hover:rotate-180 transition-transform duration-700">
                <RefreshCw className="h-6 w-6" />
              </div>
              <h3 className="text-2xl font-bold text-[#25364A] mb-4">Learn it. Spin it. Explain it.</h3>
              ...
              <button className="bg-white rounded-full px-6 py-3 font-bold text-[#25364A] border border-slate-200 shadow-sm flex items-center gap-2 group-hover:border-[#F7C928] transition-colors">
