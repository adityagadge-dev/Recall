          ...
          <tbody className="divide-y divide-slate-200 text-slate-700">
            {users.map((u) => (
              <tr key={u.id} className="hover:bg-slate-50 transition">
                ...
                <td className="p-4">
                  <span className="rounded bg-slate-50 px-2 py-0.5 font-mono text-[10px] uppercase font-bold text-purple-500">
                    {u.role}
                  </span>
                </td>
                ...
                <td className="p-4 text-right">
                  <button className="text-slate-600 hover:text-[#352A4D] font-semibold">Edit Permissions</button>
                </td>
              </tr>
            ))}
          </tbody>
  ...
  return (
    <div id="creator-approvals-page" className="space-y-8 pb-12">
      <div className="border-b border-slate-200 pb-6">
        ...
        <p className="text-xs text-slate-600 mt-1">Review institutional credentials and peer endorsements.</p>
      </div>
      <div className="rounded-3xl border border-slate-200 bg-white p-8 text-center text-slate-600 text-xs">
  ...
  return (
    <div id="course-governance-page" className="space-y-8 pb-12">
      <div className="border-b border-slate-200 pb-6">
        ...
        <p className="text-xs text-slate-600 mt-1">Verify clinical citations and cognitive load standards before public publishing.</p>
      </div>
      <div className="rounded-3xl border border-slate-200 bg-white p-6 space-y-4">
        <div className="flex items-center justify-between p-4 rounded-2xl border border-slate-200 bg-slate-50">
          <div>
            ...
            <p className="text-xs text-slate-600">Authored by Dr. Marcus Vance • Subject: Financial Literacy</p>
          </div>
  ...
  return (
    <div id="content-inspection-page" className="space-y-8 pb-12">
      <div className="border-b border-slate-200 pb-6">
        ...
        <p className="text-xs text-slate-600 mt-1">Automated fact-checking and Google ADK hallucination telemetry.</p>
      </div>
      <div className="rounded-3xl border border-purple-50 bg-white p-6 space-y-2">
        ...
        <p className="text-xs text-slate-600">All AI-generated assessment prompts passed strict grounding validation against Creator whitepapers.</p>
      </div>
    </div>
  );
};
  ...
  return (
    <div id="subject-control-page" className="space-y-8 pb-12">
      <div className="border-b border-slate-200 pb-6">
        ...
        <p className="text-xs text-slate-600 mt-1">Configure the 4 core life-skill domains and neural constellation geometry.</p>
      </div>
  ...
  return (
    <div id="gamification-control-page" className="space-y-8 pb-12">
      <div className="border-b border-slate-200 pb-6">
        ...
        <p className="text-xs text-slate-600 mt-1">Calibrate XP rewards, level thresholds, and streak multiplier rules.</p>
      </div>
      <div className="rounded-3xl border border-slate-200 bg-white p-6 space-y-4">
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div className="p-4 rounded-xl bg-slate-50 border border-slate-200">
            <span className="text-[10px] text-slate-600 font-bold uppercase">Lesson Base XP</span>
            <div className="text-xl font-bold text-[#7B61B5] font-mono">+60 XP</div>
          </div>
          <div className="p-4 rounded-xl bg-slate-50 border border-slate-200">
            <span className="text-[10px] text-slate-600 font-bold uppercase">Spin & Teach Mastery Bonus</span>
            <div className="text-xl font-bold text-[#7B61B5] font-mono">+100 XP</div>
          </div>
          <div className="p-4 rounded-xl bg-slate-50 border border-slate-200">
            <span className="text-[10px] text-slate-600 font-bold uppercase">Streak Shield Max</span>
  ...
  return (
    <div id="platform-settings-page" className="space-y-8 pb-12">
      <div className="border-b border-slate-200 pb-6">
        ...
        <p className="text-xs text-slate-600 mt-1">Environment parameters, secret rotation, and Clerk / ADK tokens.</p>
      </div>
      <div className="rounded-3xl border border-slate-200 bg-white p-6 space-y-3 font-mono text-xs">
        <div className="flex justify-between p-3 rounded-xl bg-slate-50">
          <span className="text-slate-600">FLASK_API_BASE_URL:</span>
          <span className="text-purple-500">https://api.recall.edu/v1</span>
        </div>
        <div className="flex justify-between p-3 rounded-xl bg-slate-50">
          <span className="text-slate-600">MONGODB_CONNECTION_URI:</span>
          <span className="text-purple-500">mongodb+srv://cluster-0.recall.internal</span>
        </div>
        <div className="flex justify-between p-3 rounded-xl bg-slate-50">
          <span className="text-slate-600">GOOGLE_ADK_AGENT_VERSION:</span>
  ...
  return (
    <div id="audit-trail-page" className="space-y-8 pb-12">
      <div className="border-b border-slate-200 pb-6">
        ...
        <p className="text-xs text-slate-600 mt-1">Immutable administrative action logs and compliance records.</p>
      </div>
  ...
  return (
    <div id="system-telemetry-page" className="space-y-8 pb-12">
      <div className="border-b border-slate-200 pb-6">
        ...
        <p className="text-xs text-slate-600 mt-1">Real-time infrastructure latency and node metrics.</p>
      </div>
      <div className="rounded-3xl border border-purple-50 bg-white p-6 space-y-4">
        ...
        <p className="text-xs text-slate-600">Container reverse proxy listening on 0.0.0.0:3000. Static build ready.</p>
      </div>
    </div>
  );
};
