  ...
  return (
    <div id="student-progress-page" className="space-y-8 pb-12">
      ...
      <div className="border-b border-slate-200 pb-6">
        ...
        <h1 className="text-2xl sm:text-3xl font-extrabold text-[#0F172A]">Neural Progress & Mastery</h1>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4 space-y-1">
          <span className="text-[10px] font-bold uppercase text-slate-600">Total XP Velocity</span>
          <div className="text-2xl font-black text-[#0F766E] font-mono">3,440 XP</div>
          <span className="text-[10px] text-slate-600">+780 XP this week</span>
        </div>

        <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4 space-y-1">
          <span className="text-[10px] font-bold uppercase text-slate-600">Retention Score</span>
          <div className="text-2xl font-black text-[#0F766E] font-mono">94.8%</div>
          <span className="text-[10px] text-slate-600">Teach-Back accuracy</span>
        </div>

        <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4 space-y-1">
          <span className="text-[10px] font-bold uppercase text-slate-600">Active Streak</span>
          <div className="text-2xl font-black text-teal-400 font-mono">14 Days</div>
          <span className="text-[10px] text-slate-600">2 streak shields stored</span>
        </div>

        <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4 space-y-1">
          <span className="text-[10px] font-bold uppercase text-slate-600">Cognitive Focus</span>
          <div className="text-2xl font-black text-purple-400 font-mono">18.5 Hrs</div>
          <span className="text-[10px] text-slate-600">Applied scenario time</span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-8 rounded-3xl border border-slate-200 bg-white p-6 space-y-4">
          <div className="flex items-center justify-between">
            <h3 className="text-base font-bold text-[#0F172A]">Weekly Learning Velocity</h3>
        ...
        <div className="lg:col-span-4 rounded-3xl border border-slate-200 bg-white p-6 space-y-4">
          <h3 className="text-base font-bold text-[#0F172A]">Domain Mastery</h3>
          <div className="space-y-4 pt-2">
            {subjectMasteryData.map((sub, i) => (
              <div key={i} className="space-y-1.5">
                <div className="flex justify-between text-xs">
                  <span className="font-semibold text-slate-600">{sub.name}</span>
                  <span className="font-mono font-bold text-[#0F172A]">{sub.score}%</span>
                </div>
    ...
    <motion.div id="rewards-page" initial="hidden" animate="visible" variants={{ hidden: { opacity: 0 }, visible: { opacity: 1, transition: { staggerChildren: 0.1 } } }} className="space-y-8 pb-12">
      ...
      <motion.div variants={{ hidden: { opacity: 0, y: 15 }, visible: { opacity: 1, y: 0 } }} className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 border-b border-slate-200 pb-6">
        <div>
          ...
          <h1 className="text-2xl sm:text-3xl font-extrabold text-[#0F172A]">Gamification & Badges</h1>
          <p className="text-xs text-slate-600 mt-1">
