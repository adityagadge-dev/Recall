            ...
            >
              <div>
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div className="flex items-center gap-1.5 rounded-lg border border-slate-800 bg-[#161c28] px-2.5 py-1 text-xs font-mono font-bold text-slate-300">
                ...
                <div className="space-y-1.5 mb-4">
                  <span className="text-[10px] font-bold uppercase tracking-wider text-slate-500">Core Node Skills:</span>
                  <div className="flex flex-wrap gap-1.5">
                    {sub.keyCompetencies.slice(0, 3).map((comp, i) => (
                      <span key={i} className="rounded-md border border-[#232c3d] bg-[#151a26] px-2 py-0.5 text-[10px] text-slate-300">
                        {comp}
                      </span>
                    ))}
                  </div>
              ...
              <div className="border-t border-[#1d2535] pt-3 flex items-center justify-between text-xs text-slate-500">
    ...
    >
      ...
      <div className="text-right shrink-0">
        <div className="flex items-center justify-end gap-1 font-mono text-sm font-extrabold text-lime-300">
          ...
          <span className="text-xs font-normal text-slate-500">XP</span>
        </div>
